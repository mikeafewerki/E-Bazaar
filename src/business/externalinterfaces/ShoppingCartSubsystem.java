...
public interface ShoppingCartSubsystem {
	...
	public void retrieveSavedCart() throws BackendException ;
	 ...
	 /**
	  * used to make updates to the live cart
	  * @param list
	  */
	public void updateShoppingCartItems(List<CartItem> list);
		
	/**
	 * fetches the live cart from memory. used for transforming the cartItems to orders
	 * items in the OrderSubsystem
	 * @return
	 */
	public ShoppingCart getLiveCart();
	
	/**
	 * returns the list of items in the live cart
	 * @return
	 */
   ...
   public CartItem getEmptyCartItemForTest();
	...
	/**
	 * Accessor used by customer subsystem to store user's selected bill address during checkout;
	 * stores value in shop cart facade 
	 */
	public void setBillingAddress(Address addr);
	
	/**
	 * Accessor used by customer subsystem to store user's selected payment info during checkout;
	 * stores value in shop cart facade 
	 */
   ...
   /**
    * adds a new product to the list of cart items in the live cart
    * @param name - name of the product
    * @param quantity
    * @param unitPrice
    * @param totalPrice
    */
   public void addCartItem(String name, String quantity, String unitPrice, 
