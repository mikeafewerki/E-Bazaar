...
public class DbClassShoppingCart implements DbClass, DbClassShoppingCartForTest {
	...
	private String saveCartQuery = "INSERT INTO shopcarttbl (custid,shipaddress1, " + 
    		"shipcity, shipstate, shipzipcode, billaddress1, " + 
    		"billcity, billstate, billzipcode, nameoncard, " +
    ...
    void deleteSavedCart(ShoppingCart cart) throws DatabaseException{

    	Integer id = cart.getCartId()!=null?Integer.parseInt(cart.getCartId()):null;
    	...
    	if(id != null) {
    		...
    		try{
    			...
    			LOG.severe("database error, rolling back");
    			dataAccessSS.rollback();
    			throw (e);
    		}finally{
    			dataAccessSS.releaseConnection();
