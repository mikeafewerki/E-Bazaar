...
class DbClassProduct implements DbClass, DbClassProductForTest {
	...
	private String updateProductQuery = "UPDATE Product SET totalquantity = ? "
			+ "WHERE productid = ?";
	...
	private Object[] loadProdTableParams, readProductParams, 
		readProdListParams, saveNewProdParams, deleteProdParams, updateProductParams;
	private int[] loadProdTableTypes, readProductTypes, readProdListTypes, 
	    saveNewProdTypes, deleteProdTypes, updateProductTypes;
	...
	public void updateProduct(Product product) throws DatabaseException{
		queryType = Type.UPDATE_PROD;
		updateProductParams = new Object[] {product.getQuantityAvail(),product.getProductId()};
		updateProductTypes = new int[] {Types.INTEGER, Types.INTEGER};
